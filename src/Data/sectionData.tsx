...
export const sections = [
    {
      ...
      content:  <div>
        <img style={{ height: '20rem'}} src={cityImage} alt="CityImage" />
        <div style={{float: 'right'}}>

         <SwiperCarousel  images={cityImagesCarusel} width="383.5px" autoplaySpeed={2000} transitionSpeed={2000} snapMode={false}/>
        </div>
    ...
    },
    {
      ...
      content:   <div style={{float: 'right'}}>
        <SwiperCarousel  images={UniImagesCarusel} width="564.5px" height="212.7px" autoplaySpeed={2000} transitionSpeed={10} snapMode={false} />,
        </div>
    },
    {
      id: 3,
      ...
      content: <img style={{float: 'right', height: '300px'}} src={folkstoneImage} />,
    },
    {
      id: 4,
      category: "GRAPHIC",
      ...
      content: <div>
        ...
        <div style={{float: 'right'}}>
        <SwiperCarousel  images={patasieImagesCarusel} width="490.5px" autoplaySpeed={2000} snapMode={false} transitionSpeed={1}/>
        </div>
        </div>
      ,
    },
    {
      ...
      text: "up",
      content: <div style={{float: 'right'}}>
        <SwiperCarousel  images={sketchImagesCarusel} width="441.5px" height="213px" autoplaySpeed={2000} snapMode={false} transitionSpeed={1}/>      ,
      </div>
    },
    {
      id: 6,
    ...
    },
    {
      ...
      content: <div style={{float: 'right'}}>
        <SwiperCarousel images={sportsHallImagesCarusel} width="328.55px" height="174px" autoplaySpeed={2000} snapMode={false} transitionSpeed={1}/>      ,
      </div>
    },
    {
      id: 8,
    ...
    },
    {
      ...
      content: <div>
        <div style={{float: 'left', marginTop: '2rem'}}>
          <SwiperCarousel  images={StudiesImagesCarusel} width="217px" autoplaySpeed={2000} snapMode={false} transitionSpeed={1}/>
        </div>
        <div style={{ display: 'grid', float: 'right'}}>
              <img src={studiesPic1} alt="CityImage" style={{width: '448.5px', marginBottom: '2rem', marginTop: '1rem'}} />
              <img src={studiesPic2} alt="CityImage" style={{width: '448.5px', marginBottom: '2rem'}} />
              <img src={studiesPic3} alt="CityImage" style={{width: '448.5px'}} />
          </div>
        </div>
      ,
    },
    {
      ...
      lowerTitleUrl: "http://cplushoar.com/",
      text: "Going up...",
      content: <StyledRubySection>
          <SwiperCarousel  images={RenderingImagesCarusel} width="217px" height="auto" autoplaySpeed={2000} snapMode={false} transitionSpeed={10}/>
          <img src={renderingImage1} alt="CityImage" style={{width: '421.5px', marginBottom: '2rem', marginTop: '1rem', float: 'right'}} />
        </StyledRubySection>,
    },
    {
      id: 11,
      ...
      content: <StyledFlexSpacedSection>
        <StyledSectionLink>
